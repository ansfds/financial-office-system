...
async function main(){
  ...
  for(const name of ['USDT','كروت شي إن','تحويل مبلغ','دفع فاتورة','حوالة مالية','شراء عملة','بيع عملة','استلام مبلغ','خروج مبلغ','استلام بطاقة','سحب من بطاقة','دفع قيمة بطاقة','مصروف عام']) await prisma.transactionType.upsert({where:{name},update:{},create:{name}});
