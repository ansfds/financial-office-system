...
يوجد في الإعدادات خياران منفصلان للتصفير: تصفير المعاملات فقط بعبارة `RESET SYSTEM DATA`، وتصفير كامل للمنظومة بعبارة `RESET FULL SYSTEM DATA`. التصفير الكامل يمسح بيانات الشغل فقط ويترك المستخدمين والإعدادات الأساسية والعملات وأنواع المعاملات.
